...
/* harmony import */ var _actions_core__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(253);
/* harmony import */ var _actions_core__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__nccwpck_require__.n(_actions_core__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var octokit__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require__(642);
...
try {
    ...
    packagesNames.forEach(async name => {
        ...
        if (packageVersion.status === 200) {
            ...
            const selectedPackageVersion = packageVersion.data.filter(x => x.name.toLowerCase() === versionNumber.toLowerCase())
...
/******/ 	var __webpack_exports__ = __nccwpck_require__(901);
